...
public class specificchat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendmessagecardview=findViewById(R.id.send_btn);
        msendmessagebutton=findViewById(R.id.sendmsg);
        mtoolbarofspecificchat=findViewById(R.id.toolbar_chat);
        mnameofspecificuser=findViewById(R.id.username_chat);
